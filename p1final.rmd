...
[source](https://github.com/jamespeapen/expdesign/blob/gh_pages/p1final.rmd)
...
There has been no prior work done in this area.

I hypothesize that the source of the assignment increases the duration of the
assignment.
...
add_significance() %>% add_xy_position(x = "assignment_source")
```
...
The data and the mixed model show that the source of the assignment plays an
important role in determining how long students take to complete the
assignment. However the large confidence intervals for the coefficients make me
question the relevance of this model.

It also shows, to a degree, that students who take a long time are also
likely to be students who make comments on the assignment.
...
some students had only 5 records.
